 ...
 *
 *   php tools/install-local.php                 # into ../Exten-gen/joomla
 ...
 *
 * The default is the development site in Exten-gen's tree, because there is one
 * of those and it is where Exten-gen is installed - which matters here more
 * than usual: Gen-gen with no target installed shows an empty list and says so,
