 ...
 * version of Gen-gen that needs a newer library than the one already there.
 */
class Com_GengenInstallerScript
{
    /**
     ...
     */
    private const LIBRARY_MINIMUM = '0.3.0';
